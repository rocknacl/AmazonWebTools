...
public class ContactSellerTask {
	...
	public String getRobotSelectSQL() {
		return robotSelectSQL;
	}

	public void setRobotSelectSQL(String robotSelectSQL) {
		this.robotSelectSQL = robotSelectSQL;
	}
